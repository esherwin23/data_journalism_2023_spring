...
**Answer** The columns have the same headers as they are shown on the website. Additionally, the date column is listed as a character rather than a number.
...
**Answer** URLs to the press releases in the dataframe as well as their text.
...
**Answer** The output suggests that there are no <ul> tags in the HTML source.
...
**Answer** It gives a full list of all the text on the site that is associated with the <li> tags.
...
**Answer** It's a single-column data frame that doesn't separate press release items from normal menu items on the site.
