...
**Answer** Minor differences between grantee names are preventing proper grouping. Additionally, their are repeated names with various forms of capitalization.
...
**Answer** 
- Charles County Arts Alliance Inc was changed to all caps
- Melwood Horticultural Training Center, Inc.	 was changed to Melwood Horticultural Training Center
...
**Answer** 
There was only about one change within the first 30 results, which was WASHINGTON ADVENTIST UNIVERSITY being changed to Washington Adventist University
...
**Answer** No, the changes are not substantial. However, some grantee names were changed from all caps to normal capitalization.
