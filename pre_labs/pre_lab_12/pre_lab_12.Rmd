...
**Answer** It outputs a dataframe with four columns: one for the date, title, url and text.
...
**Answer** It outputs both "Dog" and "dog", as well as a comma, all of which is not necessarily helpful.
...
**Answer** It outputs a dataframe with a single column containing every unique word within the text.
...
**Answer** The resulting graphic outputs the top 25 words from the text, such as "the" and "and", which is not interesting at all.
...
**Answer** It outputs a dataframe with unique words that are not stop words in the press releases. This is more interesting than before, displaying that words like "health" show up often.
...
**Answer** Three tibbles were outputted by the code, all of which seem to share health as a topic.
...
**Task** Run the following code and describe the results.
**Answer** Now the code outputs various 2-word combinations, such as "covid 19" and "american rescue."
...
**Task** Run the following code and describe the results.
**Answer** Now, "project location" and "amount included" are the top two phrases found within press releases in 2022.
...
**Task** Run the following code and describe the results.
**Answer** The results are very different again, now with phrases such as "human rights" and "equal rights" appearing most often.
...
**Answer** It gives us multiple dataframe for each year, each of which denotes each word as either positive or negative.
