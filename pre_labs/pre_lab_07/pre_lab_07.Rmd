...
```{r echo=FALSE}
census_api_key("5f5cf738938ea44641fde189cadaff8e32d98388", install=TRUE)
```
...
**Answer** Howard County, the wealthiest county in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** No, the differences aren't statistically significant.

Is the difference between Howard and everyone else significant? **Answer** Yes, they are statistically significant.
...
**Answer** No counties saw their median incomes fall from 2010-2021.
...
**Answer** What's the connection between the median household income for a school and the number of graduates that come from said school? What are the attitudes and expectations toward school and college entry in different zip codes or schools? 
...
**Answer** More schools in Maryland have less than 40% of graduates immediately enrolling in college, which have lower average household incomes compared to schools with higher percentages of graduates enrolling into college immediately. 
...
**Answer** One question that this data makes me think about it is financial aid and how much on average people from different zip codes receive, if any?
