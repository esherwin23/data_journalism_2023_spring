...
**Answer** It provides columns with data on the zip codes provided, the names of the areas associated with the zip codes, another format for the zip code, and information regarding the shapes and dimensions of the area on the map.
...
**Answer** It contains the same information as glimpse did above, except you can see the whole data set and all the information related to all 526 zip codes.
...
**Answer** The output is a full map of the state of Maryland, with individual sections mapped out as well, which I assume are the zip codes displayed in the dataframe. Additionally, the map is mapped onto a grid with axes for latitude and longitude.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is a dataframe for every county in the United States along with a geometry column.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output limits the data frame to only counties in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The code plots out a map that shows every county in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now, the output is a map of Maryland where you can see the county boundaries as well as the zip code boundaries within the counties.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Two columns are outputted, one with the zip code and the other with the number of foreclosures within that zip code.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** The dataset returns the 526 zip codes once again, but now with an additional column for the number of foreclosure notices.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now, the code displays a map with Maryland zip codes, each colored in based on the number of foreclosures from the data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is data frame for the counties in Maryland along with their estimated populations, as well as a data frame for number of foreclosure notices within each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is now a column for geometry in the data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the two data frames.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It removes the ", Maryland" from the county column so that data frames can be joined by the county columns.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows the 24 jurisdictions along with county names, population data, number of notices and geometry data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A new column is created for the rate of notices for foreclosure per 1,000 people.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now, the code outputs a map that shows county boundaries and colors it in based on the rate of foreclosures per 1,000 people.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map now has a different color palette that makes it easier to notice differences in the data.
...
**Answer** There is more differentiation in the colors to emphasize differences in the color. Charles County still remains as the county with the highest rate of foreclosures. 
