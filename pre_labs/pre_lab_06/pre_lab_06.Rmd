...
**Answer**  They have the same column structure, but some datasets have some of the columns in different orders.
...
**Answer** There was a significant jump in registrations for the democratic party between 2018 and 2020, while registrations for the republican party increased steadily. There was also a significant drop in registrations for the libertarian and green parties in 2020 before rising again in 2022. Additionally, registrations listed at "Other" grew significantly over the 6 year period.
```{r}
...
**Answer** There should be 24 rows, which there are.
...
**Answer** It provides information about populations of people from different races as well as for those who are over 18. 
...
**Answer** Prince George's county has the highest adult Black population, with a percentage of 60.9%, which is also 77.1% democratic.
...
**Answer** Compared to the last task, there are two counties, Howard and Montgomery, that stand out compared to the rest in terms of adult Asian population. 
...
**Answer** the ZTCA5N column is represented as a double (a number).
...
**Answer** ZCTA5N is now a character.
