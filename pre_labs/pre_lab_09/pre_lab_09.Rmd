...
https://www.datawrapper.de/_/FurnJ/ 
...
The map is zoomed in and the counties that are colored in are much clearer to see.
...
**Answer** Describe the changes from the previous map
When hovering over each county, you can now see the name of the county you are hovering over as well as the percentage of votes for Moore from that county.
...
https://www.datawrapper.de/_/5WKlN/
