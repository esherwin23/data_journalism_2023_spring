...
**A3.** I think the answer produced by my code suggests that although it is the trigram that appears the most, it might not be the most important reason most attorneys are sanctioned. The trigram appears more in some years compared to others. For example, in 2021, 33 sanctions involved conduct involving dishonesty while only four cases pertained to it in 2015. Instead of searching for the trigram that appears most among all sanctions across all fiscal years, it might be better to look for trigrams that appear the most per fiscal year. This would involve breaking the data down into multiple dataframes based on year and then finding the top unique words among each year.
