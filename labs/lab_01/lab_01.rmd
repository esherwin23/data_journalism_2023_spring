...
**A4** It would have been easier to see the answer if the data was sorted by instructors.
...
**A5** What departments offer the most classes? -> Business and Management
