...
* **Analysis summary**: [We were able to confirm that black women account for less than 1 percent of overall cases where race was known. We were also able to verify that black women are about 13.6% of the female population. However, they only account for about 18% of women shot and killed. Additionally, black women only 14% of unarmed deaths, which is about half of what the story stated.r
...
* **Analysis summary**: [We can confirm that the mean number of women shot per year was about 45, with 2018 and 2021 being possible outliers, having 52 and 56 women shot respectively. Additionally, we found that the percentage of women shot and killed was about 4.4%, which aligns pretty well with the story, but we are aware updated data could be the cause of the discrepancy.]
...
fatal_police_shootings_years <- fatal_police_shooting_data %>% 
...
mean_women_shot = (42+40+45+52+43+38+56+44)/8
# Display results of code below this codeblock
