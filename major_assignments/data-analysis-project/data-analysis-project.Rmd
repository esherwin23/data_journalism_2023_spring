...
After working with the data, we learned that there are attributes that can be taken into consideration when it comes to the popularity of songs or artists. Although the data represents the top 10 songs of various artists on Spotify, it is not a good measure or representation of the artist as a whole. There is a difference between an artist who only has 10 songs that all appear on this top streamed list compared to an artist that may have 100 songs. What about the other songs? Perhaps the songs that appear on this list are just bumps in popularity compared to their overall discography. It also does not take release date into consideration. Songs that were released a long time ago are more likely to be streamed more over time compared to newer songs. Perhaps the data could be restructured by release date to give a better understanding of how music and streaming changes over time, rather than just being a slight profile of an artist.
